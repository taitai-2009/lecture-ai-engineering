...
st.set_page_config(page_title="GPT NEO Chatbot", layout="wide")
...
st.title("🏠 GPT NEO Chatbot with Feedback")
st.write("GPT NEOモデルを使用したチャットボットです。回答に対してフィードバックを行えます。")
st.markdown("---")
...
# --- フッターなど（任意） ---
st.sidebar.markdown("---")
st.sidebar.info("開発者: [taitai2009]")